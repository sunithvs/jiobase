...
<svelte:head>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"Article","headline":"Supabase ERR_CONNECTION_TIMED_OUT in India: What It Means and How to Fix It","description":"Getting ERR_CONNECTION_TIMED_OUT with Supabase in India? Your ISP is DNS-blocking *.supabase.co. Learn exactly why this happens, how to confirm it, and how to fix it with a reverse proxy.","datePublished":"2026-02-28T00:00:00+05:30","dateModified":"2026-02-28T00:00:00+05:30","author":{"@type":"Person","name":"Sunith VS","url":"https://sunithvs.com"},"publisher":{"@type":"Organization","@id":"https://jiobase.com/#organization","name":"JioBase","logo":{"@type":"ImageObject","url":"https://jiobase.com/favicon-192.png"}},"mainEntityOfPage":{"@type":"WebPage","@id":"https://jiobase.com/blog/supabase-err-connection-timed-out-india"},"image":"https://jiobase.com/favicon-192.png"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://jiobase.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://jiobase.com/blog"},{"@type":"ListItem","position":3,"name":"Supabase ERR_CONNECTION_TIMED_OUT in India"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Is this error only happening in India?","acceptedAnswer":{"@type":"Answer","text":"The ISP-level DNS block on *.supabase.co is specific to Indian ISPs (Jio, Airtel, ACT Fibernet). If you get ERR_CONNECTION_TIMED_OUT outside India, it may be a different issue."}},{"@type":"Question","name":"My app was working yesterday. Why did it suddenly break?","acceptedAnswer":{"@type":"Answer","text":"ISP blocks can be rolled out gradually. Different ISPs implement the block at different times, and some regions within the same ISP may be affected before others."}},{"@type":"Question","name":"Will the proxy add latency to my API calls?","acceptedAnswer":{"@type":"Answer","text":"Minimal. JioBase runs on Cloudflare's edge network with 300+ locations. The proxy adds roughly 1-5ms of overhead per request, far less than a VPN."}},{"@type":"Question","name":"Can I self-host a proxy instead of using JioBase?","acceptedAnswer":{"@type":"Answer","text":"Yes. JioBase provides a free Worker Generator Tool that creates a ready-to-deploy Cloudflare Worker for basic HTTP proxying. The self-hosted version does not include WebSocket support."}}]}]})}</script>`}
</svelte:head>
