...
<svelte:head>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"Article","headline":"How to Test if Your Backend is Blocked by Indian ISPs","description":"A practical guide to diagnose whether Indian ISPs like Jio, Airtel, or ACT Fibernet are DNS-blocking your Supabase backend. Includes terminal commands, scripts, and step-by-step tests.","datePublished":"2026-02-28T00:00:00+05:30","dateModified":"2026-02-28T00:00:00+05:30","author":{"@type":"Person","name":"Sunith VS","url":"https://sunithvs.com"},"publisher":{"@type":"Organization","@id":"https://jiobase.com/#organization","name":"JioBase","logo":{"@type":"ImageObject","url":"https://jiobase.com/favicon-192.png"}},"mainEntityOfPage":{"@type":"WebPage","@id":"https://jiobase.com/blog/test-if-backend-blocked-india"},"image":"https://jiobase.com/favicon-192.png"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://jiobase.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://jiobase.com/blog"},{"@type":"ListItem","position":3,"name":"Test if Your Backend is Blocked by Indian ISPs"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I know if it is an ISP block vs a Supabase outage?","acceptedAnswer":{"@type":"Answer","text":"Check status.supabase.com first. If Supabase reports all systems operational, test from a VPN or ask someone outside India to try. If it works from non-Indian IPs but fails from Indian ones, it is an ISP block."}},{"@type":"Question","name":"Does the block affect all Supabase projects or just mine?","acceptedAnswer":{"@type":"Answer","text":"The block targets the entire *.supabase.co domain, not individual projects. Every Supabase project is affected on blocked ISPs."}},{"@type":"Question","name":"Can I test the block from outside India?","acceptedAnswer":{"@type":"Answer","text":"Yes, indirectly. Use online tools like check-host.net or ping.pe that have test servers in India. They will run DNS lookups and ping tests from Indian servers on your behalf."}},{"@type":"Question","name":"Will the block affect my server-side code?","acceptedAnswer":{"@type":"Answer","text":"It depends on where your server is hosted. Servers on cloud providers outside India can reach Supabase directly. Client-side code in users' browsers in India is always affected."}},{"@type":"Question","name":"How do I monitor for future blocks?","acceptedAnswer":{"@type":"Answer","text":"Set up uptime monitoring that checks your Supabase endpoint from an Indian server. Alternatively, using a reverse proxy like JioBase makes your app immune to future DNS blocks."}}]}]})}</script>`}
</svelte:head>
