...
<svelte:head>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"Article","headline":"How to Proxy Supabase Through Cloudflare Workers (Step-by-Step)","description":"Step-by-step tutorial on building a Cloudflare Worker reverse proxy for Supabase. Covers HTTP proxying, WebSocket Realtime support, CORS, DNS configuration, and deployment.","datePublished":"2026-02-27T00:00:00+05:30","dateModified":"2026-02-27T00:00:00+05:30","author":{"@type":"Person","name":"Sunith VS","url":"https://sunithvs.com"},"publisher":{"@type":"Organization","@id":"https://jiobase.com/#organization","name":"JioBase","logo":{"@type":"ImageObject","url":"https://jiobase.com/favicon-192.png"}},"mainEntityOfPage":{"@type":"WebPage","@id":"https://jiobase.com/blog/proxy-supabase-cloudflare-workers"},"image":"https://jiobase.com/favicon-192.png"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://jiobase.com"},{"@type":"ListItem","position":2,"name":"Blog","item":"https://jiobase.com/blog"},{"@type":"ListItem","position":3,"name":"Proxy Supabase Through Cloudflare Workers"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do I need a paid Cloudflare plan?","acceptedAnswer":{"@type":"Answer","text":"No. The Cloudflare Workers free tier includes 100,000 requests per day, which is sufficient for most development and production apps."}},{"@type":"Question","name":"Will Supabase Auth (cookies, sessions) work through the proxy?","acceptedAnswer":{"@type":"Answer","text":"Yes. The proxy forwards all headers, cookies, and request bodies unchanged. Supabase Auth works exactly the same through the proxy."}},{"@type":"Question","name":"Can I use this with Supabase Storage file uploads?","acceptedAnswer":{"@type":"Answer","text":"Yes. File uploads, downloads, signed URLs, and bucket management all work through the proxy. The Worker streams request and response bodies efficiently."}},{"@type":"Question","name":"How much latency does the proxy add?","acceptedAnswer":{"@type":"Answer","text":"Typically 1-5ms. Cloudflare Workers execute at the edge location closest to your users (300+ global locations), so the additional hop is minimal."}},{"@type":"Question","name":"Can I skip the manual setup and use a managed solution?","acceptedAnswer":{"@type":"Answer","text":"Yes. JioBase provides a managed Supabase reverse proxy with all the features described in this tutorial, plus a dashboard, analytics, rate limiting, and automatic updates."}},{"@type":"Question","name":"Want a quick start without Wrangler CLI?","acceptedAnswer":{"@type":"Answer","text":"Try the Worker Generator Tool. Enter your Supabase URL, copy the generated code, and paste it directly into Cloudflare's dashboard editor. No CLI needed."}}]}]})}</script>`}
</svelte:head>
