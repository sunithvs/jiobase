	...
	<form onsubmit={handleSubmit} class="mt-6 max-w-lg space-y-5">
		...
		<div>
			...
			<input id="name" type="text" bind:value={name} required
				class="w-full rounded-lg border border-white/10 bg-surface-200 px-3 py-2.5 text-white focus:border-brand-400 focus:ring-1 focus:ring-brand-400 focus:outline-none" />
		</div>
